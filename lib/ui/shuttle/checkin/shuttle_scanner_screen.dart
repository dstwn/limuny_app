...
class CheckInShuttleScanner extends StatefulWidget {
  const CheckInShuttleScanner({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _CheckInScannerScanner();
}

class _CheckInScannerScanner extends State<CheckInShuttleScanner> {
  Barcode? result;
